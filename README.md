...
# Run the container
docker run -d -p 3000:3000 -v atom_data:/app/data atom-homepage
```
...
Made with ❤️ by [Sudheer Bhuvana](https://github.com/sudheerbhuvana) under the MIT License - see the [LICENSE](LICENSE) file for details. 
